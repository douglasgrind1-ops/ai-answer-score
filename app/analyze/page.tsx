      ...
      <div className="mx-auto max-w-6xl px-6 py-12">
        <div className="mb-10">
          ...
          <h1 className="flex items-center gap-3 text-4xl font-bold tracking-tight">
            <span>✦</span>
            <span>AI Answer Score Report</span>
          </h1>
          <p className="mt-3 max-w-3xl text-lg leading-8 text-slate-600">
            A fast trust analysis of the AI-generated answer, with the primary
            issue surfaced first and an improved prompt to get a better answer.
          </p>
        </div>
